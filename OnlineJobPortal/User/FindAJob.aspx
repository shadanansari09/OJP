<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="FindAJob.aspx.cs" Inherits="OnlineJobPortal.User.FindAJob" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="select-Categories  pl-150 pt-30 pb-30">
        ...
        <div class="search">
            <asp:TextBox ID="txtSearchJobs" runat="server"></asp:TextBox>
                                        ...
                                        <div class="single-job-items mb-30">
                                            ...
                                            <div class="items-link items-link2 f-right">
                                                ...
                                                <span class="text-secondary">
                                                    ...
                                                    <%# RelativeDate(Convert.ToDateTime(Eval("CreatedOn"))) %>
