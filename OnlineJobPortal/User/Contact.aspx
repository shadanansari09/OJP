<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="OnlineJobPortal.User.Contact" EnableEventValidation="false"%>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mt-3">
                                <%--<button type="submit" class="button button-contactForm boxed-btn">Send</button>--%>
                                   <asp:Button ID="btnSend1" runat="server" Text="Send" CssClass="button button-contactForm boxed-btn" OnClick="btnSend1_Click"/>
                            </div>
                        </div>
                        <%--</form>--%>
                    </div>
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>Bhiwandi, Thane.</h3>
                                <p>Nizampura, 421302</p>
                            </div>
                        </div>
                        <div class="media contact-info">
